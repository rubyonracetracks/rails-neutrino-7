...
system('mv mod-08-01-application_helper_test.rb test/helpers/application_helper_test.rb')

puts 'Adding title helper'
system('mv mod-08-01-application_helper.rb app/helpers/application_helper.rb')
