...
system('bundle exec rails generate integration_test test2', exception: true)
sleep 0.01
...
system('bundle exec rails generate integration_test test3', exception: true)
sleep 0.01
...
system('mv mod-05-03-public_index.html public/index.html', exception: true)
system('mv mod-05-03-public_about.html public/about.html', exception: true)
