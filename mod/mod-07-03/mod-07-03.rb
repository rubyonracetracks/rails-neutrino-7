...
system('mv mod-07-03-bin-rails-erd bin/rails-erd')
system('chmod +x bin/rails-erd')
...
system('mv mod-07-03-docker-rails-erd docker/rails-erd')
system('chmod +x docker/rails-erd')
