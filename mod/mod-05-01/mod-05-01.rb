...
system('mv mod-05-01-rake_run_reporter.rb test/rake_rerun_reporter.rb', exception: true)

puts 'Adding first integration test'
system('bin/rails generate integration_test test1', exception: true)
sleep 0.01
...
system('mv mod-05-01-public_index.html public/index.html', exception: true)
